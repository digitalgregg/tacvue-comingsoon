...
// import SupportInput from "@views/SupportRequest/components/SupportInput";
  ...
  return (
    ...
    >
      <div className="px-5 lg:px-0 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-h-[95vh] overflow-y-auto scrollbar_thin">
        <div className="w-[97vw] lg:max-w-[1040px] bg-[#15192B] rounded-[20px] px-5 py-8 lg:px-[30px] lg:py-10">
          ...
          <div className="mt-[30px] lg:mt-[60px]">
            <form>
              <div className="space-y-[30px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-[30px]">
                  {/* <SupportInput label="Email" placeholder="Email here" />
                  <SupportInput label="Website" placeholder="https://" /> */}
                </div>
                ...
                <label className="w-full block">
                  ...
                  <textarea
                    ...
                    className="__support_input resize-none"
                    rows={4}
                  ></textarea>
                </label>
              </div>
              ...
              <div
                className={cx(
                  "flex md:flex-row w-full gap-5 lg:gap-7 justify-end mt-[60px] flex-row",
                )}
              >
                <button
                  type="button"
                  onClick={onClose}
                  className={cx(
                    "text-base lg:text-xl grow px-7 lg:!grow-0 lg:!px-[80px] !py-5 font-medium shrink-0 rounded-full text-[#576993] hover:text-[#6679a5] border-[3px] border-[#576993] hover:border-[#6679a5]",
                  )}
                >
                  Cancel
                </button>
                <button
                  ...
                  type="submit"
                  className={cx(
                    "text-base lg:text-xl !grow px-7 lg:!grow-0 lg:!px-[80px] !py-5 font-medium shrink-0 rounded-full relative",
                  )}
                >
                  {isSubmiting && (
