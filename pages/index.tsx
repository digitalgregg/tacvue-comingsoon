                        ...
                        <div className="grid md:grid-cols-[auto,400px] gap-20 place-items-center">
                            <div className="md:pr-20 ">
                                ...
                                >
                                    ...
                                    game mechanics, decentralized finance and digital identity into
                                    ...
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            >
                                                ...
                                                content to their community instead of fighting for
                                                space on a never-ending timeline. They earn $AVAX
                                                for selling their digital merchandise to their
                                                biggest fans.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            >
                                                Collectors can exchange assets with other collectors
                                                as a means of portraying their social identity and
                                                establishing an immutable record of sponsorship for
                                                certain projects and creators. They can earn
                                                financial rewards for finding undervalued creations
                                    ...
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            <p
                                                ...
                                                className={`${paragraphClasses} md:w-[80%]`}
                                            >
                                                Our smart contracts are highly secure and efficient
                                                and tested by the best hackers in the world. We are
                                                continually evolving our safety standards in order
                                                to provide our members with the highest level of
                                                security, so they can use our protocol without the
                                                stress or spam
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div>
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            >
                                                Gone are the days of centralized brand development
                                                that have become commonplace in the world of social
                                                media and Discord DAOs. We provide promotional tools
                                                to our most engaged users in order to provide the
                                                most committed creators and collectors with the
                                                highest visibility on our platform.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            <p
                                                ...
                                                className={`${paragraphClasses} md:w-[80%]`}
                                            >
                                                The TacVue system allows for new ideas and creations
                                                to gain attention and customer traction before the
                                                next phase of organizational development. This
                                                allows for members to see the emerging ideas and
                                                projects that have the potential to take our world
                                                by storm.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid md:grid-cols-[90px,auto] gap-10 relative z-10">
                                        ...
                                        <div className="text-center md:text-left">
                                            ...
                                            <p
                                                ...
                                                className={`${paragraphClasses} md:w-[85%]`}
                                            >
                                                The TacVue platform is designed to be fun. Instead
                                                of educating our members on every aspect of the
                                                system, we use gamification to provide an intuitive
                                                process that lets members have fun while learning
                                                about the tools of decentralized finance and
                                                cryptocurrency.
                                            </p>
                                        </div>
                                    </div>
