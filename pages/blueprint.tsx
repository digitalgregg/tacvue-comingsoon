        ...
        <div className="container">
          <div className="w-[80%] mx-auto relative">
            ...
            <div
              ...
              className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-full"
            ></div>
            {/* Line --End-- */}
            ...
            <div className="grid grid-cols-2">
              <div></div>
              <div className="relative">
                <div className="w-[500px] h-24 bg-slate-900"></div>
                <div
                  style={{
                    background:
                      "linear-gradient(#091C4A,#091C4A) padding-box padding-box, linear-gradient(91.52deg, #6396F9 40.77%, #00D1FF 115.11%) border-box border-box",
                  }}
                  className="w-10 h-10 rounded-full absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/2 border-[3px] border-transparent"
                ></div>
              </div>
            </div>
          </div>
