      ...
      <div className="container">
        <div className="px-4 text-center">
          ...
          <p className="mt-[47px] font-base sm:w-[80%] md:w-[650px] 2xl:w-[738px] flex mx-auto sm:text-[18px] md:text-[20px] lg:text-[22px] 2xl:text-[26px] xl:text-[20px] font-normal tracking-widest leading-[200%]">
            We exist to create transparent media solutions and provide
            newoutlets for cultrual revolution. We do not follow models, we
            develop them. We build for the future, not the present.
          </p>
        </div>
      </div>
    </section>
